...
## 更新摘要
**变更内容**   
- 重构工作流架构：从跨仓库通知系统简化为定时更新模式
- 移除复杂的令牌认证需求，简化配置流程
- 更新actions/checkout版本到v7，提升兼容性和性能
- 简化GitHub Actions集成复杂度，提高易用性
...
## 简介
本指南面向希望在GitHub Actions中集成Language Donut工具的用户，提供从入门到进阶的完整说明。经过架构重构后，现在提供了更简洁、更易用的定时更新模式，无需复杂的跨仓库通知系统和令牌认证。内容涵盖：
- Action输入参数与环境变量配置
- 输出文件处理与提交策略
...
- **关键要素**
  ...
  - 结合缓存与条件判断提升效率
- **更新说明**
  - 已更新actions/checkout到v7版本，提供更好的兼容性
...
- **关键步骤**
  ...
  - 结合缓存与条件判断，减少不必要的执行
- **更新说明**
  - 使用actions/checkout v7获得更好的性能和兼容性
...
**更新后的优势**
- 简化的架构设计，移除了复杂的跨仓库通知系统
- 无需复杂的令牌认证，降低了配置难度
- 更新的actions/checkout v7提供更好的兼容性和性能
- 更加稳定和易用的定时更新模式